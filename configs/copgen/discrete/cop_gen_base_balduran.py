...
def modality_configs():
    ...
    all_modality_configs = {
        ...
        "DEM_DEM": d(
            modality_type="image",
            bands=['DEM'],
            autoencoder_path="models_balduran/vae/DEM_64x64_DEM_latent_8/model-50-ema.pth",
        ...
        "S1RTC_vh_vv": d(
            modality_type="image",
            bands=['vv', 'vh'],
            autoencoder_path="models_balduran/vae/S1RTC_192x192_VV_VH_latent_8/model-50-ema.pth",
            latent_channels=8,                  # latent z_channels (8, *, *)
        ...
        "S2L1C_B02_B03_B04_B08": d(
            ...
            autoencoder_path="models_balduran/vae/S2L1C_192x192_B4_3_2_8_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(24, 24), # latent input size (8, 24, 24)
        ...
        "S2L1C_B05_B06_B07_B11_B12_B8A": d(
            ...
            autoencoder_path="models_balduran/vae/S2L1C_96x96_B5_6_7_8A_11_12_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
        ...
        "S2L1C_B01_B09_B10": d(
            modality_type="image",
            bands=['B01', 'B09', 'B10'],
            autoencoder_path="models_balduran/vae/S2L1C_32x32_B1_9_10_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
        ...
        "S2L2A_B02_B03_B04_B08": d(
            modality_type="image",
            bands=['B04', 'B03', 'B02', 'B08'],
            autoencoder_path="models_balduran/vae/S2L2A_192x192_B4_3_2_8_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(24, 24), # latent input size (8, 24, 24)
            img_bands=4,                      # number of bands   (4)
            img_input_resolution=(192, 192),  # input pixel space (4, 192, 192)
        ...
        "S2L2A_B05_B06_B07_B11_B12_B8A": d(
            modality_type="image",
            bands=['B05', 'B06', 'B07', 'B8A', 'B11', 'B12'],
            autoencoder_path="models_balduran/vae/S2L2A_96x96_B5_6_7_8A_11_12_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(12, 12), # latent input size (8, 12, 12)
            img_bands=6,                      # number of bands   (6)
            img_input_resolution=(96, 96),    # input pixel space (6, 96, 96)
        ...
        "S2L2A_B01_B09": d(
            modality_type="image",
            bands=['B01', 'B09'],
            autoencoder_path="models_balduran/vae/S2L2A_32x32_B1_9_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(4, 4),   # latent input size (8, 4, 4)
            img_bands=2,                      # number of bands   (2)
        ...
        "LULC_LULC": d(
            modality_type="image",
            bands=['LULC'],
            autoencoder_path="models_balduran/vae/LULC_192x192_LULC_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(24, 24), # latent input size (8, 24, 24)
        ...
        "S2L1C_cloud_mask": d(
            modality_type="image",
            bands=['cloud_mask'],
            autoencoder_path="models_balduran/vae/S2L1C_192x192_cloud_mask_latent_8/model-50-ema.pth",
            latent_channels=8,                # latent z_channels (8, *, *)
            latent_input_resolution=(24, 24), # latent input size (8, 24, 24)
...
def get_config():
    ...
    config.train = d(
        ...
        batch_size=512,  # Change to 512
        gradient_accumulation_steps=2, # Effective BS with 4 GPUs is 4096
        num_workers=8,
        mode="uncond",
        log_interval=200, # Change to 100
        eval_interval=1000, # Change to 5000
        save_interval=1000, # Change to 5000
        multi_modal=True,
    )
    config.optimizer = d(
        name="adamw",
    ...
    config.dataset = d(
        ...
        # path="/tmp/majorTOM/world/latents/train_merged",
        path="/work/scratch-pw3/mespi/majorTOM/world/latents/train_merged",
        # path="/localdisk/home/s2254242/datasets/majorTOM/world/dev_lmdb/dev_lmdb_test",
        # path="/work/scratch-pw3/mespi/majorTOM/world/dev_lmdb/dev_lmdb_test",
        cfg=False,
        p_uncond=0.1, # 0.15
        patches_per_side=6,
        ...
        precomputed_lat_lon_path="assets/3d_cartesian_lat_lon_cache.pkl",
        time_encode='mean_timestamps',
        precomputed_mean_timestamps_path="assets/mean_timestamps_cache.pkl",
        random_flip=False,
