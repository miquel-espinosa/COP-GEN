...
def modality_configs():
    ...
    all_modality_configs = {
        ...
        "S2L2A_B01_B09": d(
            modality_type="image",
            autoencoder_path="old_models/S2L2A_40x40_B1_9_latent_8/model-35-ema.pth",
        ...
        "S2L2A_B02_B03_B04_B08": d(
            modality_type="image",
            autoencoder_path="old_models/S2L2A_240x240_B4_3_2_8_latent_8/model-22-ema.pth",
            latent_channels=8,           # latent z_channels (8, *, *)
        ...
        "S2L2A_B05_B06_B07_B11_B12_B8A": d(
            modality_type="image",
            autoencoder_path="old_models/S2L2A_120x120_B5_6_7_8A_11_12_latent_8/model-20-ema.pth",
            latent_channels=8,          # latent z_channels (8, *, *)
...
def get_config():
    ...
    config.dataset = d(
        ...
        precomputed_mean_timestamps_path="assets/s2_test_mean_timestamps_cache.pkl",
        random_flip=False,
