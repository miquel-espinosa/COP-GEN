...
def modality_configs():
    ...
    all_modality_configs = {
        "S2L2A_B01_B09": d(
            ...
            latent_input_resolution=22, # latent input size (8, 22, 22)
        ...
        "S2L2A_B05_B06_B07_B11_B12_B8A": d(
            ...
            latent_channels=8,          # latent z_channels (8, *, *)
            latent_input_resolution=66, # latent input size (8, 66, 66)
...
def get_config():
    ...
    config.dataset = d(
        ...
        path="data/majorTOM/small_world/latents_lmdb/train",
        cfg=False,
        p_uncond=0.1, # 0.15
        random_flip=True,
