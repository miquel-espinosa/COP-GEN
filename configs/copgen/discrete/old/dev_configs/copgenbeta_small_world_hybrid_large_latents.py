...
def modality_configs():
    ...
    all_modality_configs = {
        "DEM_thumbnail": d(
            ...
            latent_input_resolution=132, # latent input size (4, 132, 132)
        ...
        "S2L2A_B02_B03_B04_B08": d(
            ...
            latent_input_resolution=132, # latent input size (8, 132, 132)
...
def get_config():
    ...
    config.train = d(
        ...
        eval_interval=1000, # Change to 1500
        save_interval=5000,
        multi_modal=True,
    )
    config.optimizer = d(
    ...
    config.dataset = d(
        ...
        path="data/majorTOM/small_world/copgenbeta_hybrid_latents_lmdb/train",
        cfg=False,
        p_uncond=0.1, # 0.15
        random_flip=True,
