...
export EXP_GT_S2_GEN_S1_ROOT=$SEN1FLOODS11_ROOT/outputs/GEN_S1_FROM_S2L1C
...
for split in train test val; do
    python3 copgen_eval/sen1floods11/generate_sen1floods11.py \
        ...
        --condition_modalities S2L1C_B01_B09_B10 S2L1C_B02_B03_B04_B08 S2L1C_B05_B06_B07_B11_B12_B8A \
