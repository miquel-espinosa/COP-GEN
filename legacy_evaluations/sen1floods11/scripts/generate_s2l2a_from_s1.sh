...
export EXP_GT_S1_GEN_S2_ROOT=$SEN1FLOODS11_ROOT/outputs/GEN_S2L2A_FROM_S1
...
for tif in $EXP_GT_S1_GEN_S2_ROOT/v1.1/data/flood_events/HandLabeled/S2L2A/*.tif; do
