...
#SBATCH --job-name=tar-world-S2L2A
#SBATCH --mem=100G
##------------------------ End job description ------------------------
...
# PATHS
SOURCE_DIR="/work/scratch-pw2/mespi/majorTOM/world/Core-S2L2A"
TARGET_DIR="/gws/nopw/j04/sensecdt/data/internal/majorTOM/world/Core-S2L2A-tar-gz"
NUM_WORKERS=16
