...
#SBATCH --job-name=tar-world-LULC
#SBATCH --mem=100G
##------------------------ End job description ------------------------
...
# PATHS
SOURCE_DIR="/gws/nopw/j04/sensecdt/data/internal/majorTOM/world/Core-LULC"
TARGET_DIR="/gws/nopw/j04/sensecdt/data/internal/majorTOM/world/Core-LULC-tar-gz"
NUM_WORKERS=16
