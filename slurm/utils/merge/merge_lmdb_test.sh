...
#SBATCH --job-name=merge_lmdb_test
#SBATCH --mem=400G
##------------------------ End job description ------------------------
module purge && source /gws/nopw/j04/sensecdt/users/mespi/virtualenvs/triffuser/bin/activate

# Copy lmdb files to /tmp NVMe disk
src_dir="/work/scratch-pw3/mespi/majorTOM/world/latents/test"
dst_dir="/tmp/majorTOM/world/latents/test"
final_dir="/work/scratch-pw3/mespi/majorTOM/world/latents/test_merged"
