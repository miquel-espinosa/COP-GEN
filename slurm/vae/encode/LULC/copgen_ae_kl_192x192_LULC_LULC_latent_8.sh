...
#SBATCH --job-name=encode_copgen_ae_kl_192x192_LULC_LULC_latent_8
#SBATCH --mem=400G
##------------------------ End job description ------------------------
...
# export SOURCE_DIR="/gws/nopw/j04/sensecdt/data/internal/majorTOM/world/Core-LULC-tar-gz"
export SOURCE_DIR="/work/scratch-pw2/mespi/majorTOM/world/Core-LULC-tar-gz"
export TMP_DIR="/tmp/majorTOM/world/Core-LULC"
...
accelerate launch --multi_gpu --num_processes 4 encode_moments_vae.py \
  --cfg ./configs/copgen/final/LULC/copgen_ae_kl_192x192_LULC_LULC_latent_8.yaml \
  --checkpoint_path ./models/LULC_192x192_LULC_latent_8/model-50.pt \
