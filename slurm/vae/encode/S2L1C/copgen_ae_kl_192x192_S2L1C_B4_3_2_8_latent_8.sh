...
#SBATCH --job-name=encode_copgen_ae_kl_192x192_S2L1C_B4_3_2_8_latent_8
#SBATCH --mem=400G
##------------------------ End job description ------------------------
...
# Delete wrong entry for S2L1C
python3 /home/users/mespi/projects/triffuser/scripts/delete_entry_from_pickle.py \
  -s S2L1C \
  -i 536U_904R \
  -d $TMP_DIR
...
accelerate launch --multi_gpu --num_processes 4 encode_moments_vae.py \
  --cfg ./configs/copgen/final/S2L1C/copgen_ae_kl_192x192_S2L1C_B4_3_2_8_latent_8.yaml \
  --checkpoint_path ./models/S2L1C_192x192_B4_3_2_8_latent_8/model-50.pt \
