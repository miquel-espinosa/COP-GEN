...
#SBATCH --job-name=encode_copgen_ae_kl_192x192_small_google
#SBATCH --mem=400G
##------------------------ End job description ------------------------
...
export SOURCE_DIR="/work/scratch-pw3/mespi/majorTOM/world/Core-small_google-tar-gz"
export TMP_DIR="/tmp/majorTOM/world/Core-small_google"
...
export DEST_DIR_LMDB="/work/scratch-pw3/mespi/majorTOM/world/latents_small_google"

accelerate launch --multi_gpu --num_processes 4 encode_moments_vae.py \
  --cfg ./configs/copgen/final/GOOGLE_EMBEDS/copgen_192x192_small_google.yaml \
