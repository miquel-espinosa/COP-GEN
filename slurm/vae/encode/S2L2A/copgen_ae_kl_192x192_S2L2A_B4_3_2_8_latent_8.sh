...
#SBATCH --job-name=encode_copgen_ae_kl_192x192_S2L2A_B4_3_2_8_latent_8
#SBATCH --mem=400G
##------------------------ End job description ------------------------
...
# export SOURCE_DIR="/gws/nopw/j04/sensecdt/data/internal/majorTOM/world/Core-S2L2A-tar-gz"
export SOURCE_DIR="/work/scratch-pw3/mespi/majorTOM/world/Core-S2L2A-tar-gz"
export TMP_DIR="/tmp/majorTOM/world/Core-S2L2A"
...
accelerate launch --multi_gpu --num_processes 4 encode_moments_vae.py \
  --cfg ./configs/copgen/final/S2L2A/copgen_ae_kl_192x192_S2L2A_B4_3_2_8_latent_8.yaml \
  --checkpoint_path ./models/S2L2A_192x192_B4_3_2_8_latent_8/model-50.pt \
