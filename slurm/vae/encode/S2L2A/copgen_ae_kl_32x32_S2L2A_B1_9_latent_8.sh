...
#SBATCH --job-name=encode_copgen_ae_kl_32x32_S2L2A_B1_9_latent_8
#SBATCH --mem=400G
##------------------------ End job description ------------------------
...
accelerate launch --multi_gpu --num_processes 4 encode_moments_vae.py \
  --cfg ./configs/copgen/final/S2L2A/copgen_ae_kl_32x32_S2L2A_B1_9_latent_8.yaml \
  --checkpoint_path ./models/S2L2A_32x32_B1_9_latent_8/model-50.pt \
