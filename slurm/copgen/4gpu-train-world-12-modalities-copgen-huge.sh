...
#SBATCH --qos=orchid48
#SBATCH --gres=gpu:4
#SBATCH -x gpuhost015,gpuhost016,gpuhost013,gpuhost006
#SBATCH --cpus-per-task=32
#SBATCH --job-name=train-4gpu-copgen-huge
#SBATCH --mem=450G
##------------------------ End job description ------------------------
...
export NUM_GPUS=4
####SBATCH -x gpuhost015,gpuhost016,gpuhost013,gpuhost010,gpuhost011
...
./slurm/clean_checkpoints.sh workdir/copgen/discrete/cop_gen_huge/default/ckpts
