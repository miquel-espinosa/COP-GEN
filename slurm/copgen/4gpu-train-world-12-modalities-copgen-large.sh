...
#SBATCH --qos=orchid48
#SBATCH --gres=gpu:4
#SBATCH -x gpuhost015,gpuhost016,gpuhost013
#SBATCH --cpus-per-task=32
#SBATCH --job-name=train-4gpu-copgen-large
#SBATCH --mem=450G
##------------------------ End job description ------------------------
...
./slurm/clean_checkpoints.sh workdir/copgen/discrete/cop_gen_large/default/ckpts
...
accelerate launch \
            ...
            train_copgen_discrete.py \
                --config="configs/copgen/discrete/cop_gen_large.py"
